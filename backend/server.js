...
// The page fetch, its cache and the slug aliases live in screener/fetchHtml.js
// so the nightly fundamentals ingest can use them without booting the server.
const { fetchScreenerHTML, SCREENER_TTL, SCREENER_SLUG_ALIASES } = require('./screener/fetchHtml');
